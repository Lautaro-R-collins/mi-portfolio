  ...
  resources: {
    es: {
      translation: {
        ...
        "description": "Hola, mi nombre es <0 class='different'>Lautaro Rodriguez Collins</0>. Mi interés por la tecnología y la programación surgió mientras cursaba una Tecnicatura Universitaria en Producción y Automatización, donde en mi clase de informática tuve mi primer contacto con el mundo de la programación. Motivado por la curiosidad, continué estudiando de manera autodidacta, luego en una Tecnicatura de grado Universitaria enfocada en el <0 class='different'>desarrollo de software</0>, además de realizar diversos cursos. Siempre estoy comprometido con un constante crecimiento y mejora en mis habilidades. Actualmente, me desempeño como<0 class='different'> desarrollador de software freelance full-stack </0>, con un enfoque en el desarrollo <0 class='different'>front-end</0> y la experiencia del usuario.",
    ...
    en: {
      translation: {
        ...
        "description": "Hello, my name is <0 class='different'>Lautaro Rodriguez Collins</0>. My interest for technology and programming arose while I was pursuing a University Technical Degree in Production and Automation, where in my computer science class, I had my first contact with the world of programming. Motivated by curiosity, I continued to study independently, then in a University Degree Technical Course focused on <0 class='different'>software development</0>, in addition to taking various courses. I am always committed to constant growth and improvement in my skills. Currently, I work as a <0 class='different'>freelance full-stack software developer</0>, with a focus on <0 class='different'>front-end</0> development and user experience.",
